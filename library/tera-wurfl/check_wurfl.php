...
<?php
/*
 * $Id: check_wurfl.php,v 1.1.2.1.2.3 2007/01/22 22:42:13 kamermans Exp $
...
$cached = ($wurflObj->found_in_cache)? "<strong>(Found in cache)</strong>": "";
echo "<br>Total Queries: ".$wurflObj->num_queries." $cached<br>\n";
