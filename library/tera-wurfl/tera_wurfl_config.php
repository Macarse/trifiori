 ...
 * $Id: tera_wurfl_config.php,v 1.1.4.5.2.22 2007/05/09 20:09:13 kamermans Exp $
 ...
 * DB_CACHE_TABLE		string, database table name for the Cache
 ...
 * WURFL_CACHE_ENABLE	boolean,enables the DB caching system
 ...
 * Database username
 */
define("DB_USER","wurfl");
/**
 * Database password
 */
define("DB_PASS","wurfl");
/**
 * Database schema (the database name itself)
 */
define("DB_SCHEMA","tera-wurfl");
/**
...
/**
 * The table you want to use to store the temporary cache data (given caching
 * is enabled below).
 */
define("DB_CACHE_TABLE", "tera_wurfl_cache");
/**
